...
$purchase_form_page_title = get_field('purchase_form_page_title');
$purchase_form_page_description = get_field('purchase_form_page_description');
$purchase_form_page_image = get_field('purchase_form_page_image');
$purchase_form_page_form_description = get_field('purchase_form_page_form_description');
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-7">
                            <h1 class="pxp-page-header"><?php echo $purchase_form_page_title; ?></h1>
                            <p class="pxp-text-light"><?php echo $purchase_form_page_description; ?></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-sm-12 col-lg-6">
                            ...
                            <div id="form-id">
                                <div id="investment-form-content">
                                    <p class="pxp-text-light"><?php echo $purchase_form_page_form_description; ?></p>
