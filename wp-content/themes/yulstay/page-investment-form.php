            ...
            <div class="pxp-contact pxp-content-wrapper banner-mtop">
                ...
                <div class="container mt-100">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-6 pxp-cta-3-image pxp-cover rounded-lg" style="background-image: url(<?php echo $invesment_form_page_image; ?>);">
