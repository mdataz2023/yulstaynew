                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <a href="<?php the_permalink(); ?>" class="pxp-posts-1-item">
                                        ...
                                        <div class="pxp-posts-1-item-details">
                                            ...
                                            <div class="pxp-posts-1-item-details-date mt-2">April 9, 2024</div>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <a href="single-post.html" class="pxp-posts-1-item">
                                        <div class="pxp-posts-1-item-fig-container">
                                            <div class="pxp-posts-1-item-fig pxp-cover" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/team.jpg);"></div>
                                        </div>
                                        <div class="pxp-posts-1-item-details">
