        ...
        <div class="pxp-content">
            <div class="pxp-services-h pt-100 pb-100">
                <div class="container">
                    ...
                    <a href="<?php bloginfo('url'); ?>/rental-management-form" class="pxp-primary-cta text-uppercase pxp-animate"><span class="fa fa-phone"></span> <?php _e('rental management Form','theme-text-domain'); ?></a>
