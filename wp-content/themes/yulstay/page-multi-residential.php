...
$the_query = new WP_Query( array('post_type' =>'multi-residential','posts_per_page' => '1000',  'post__not_in'   => array( $id),) );
?>
                                ...
                                <select class="custom-select" id="pxp-p-filter-type">
                                 ...
                                 wp_posts p join
                                     ...
                                     MUNICIPALITES m ON m.CODE = i.MUN_CODE
                                         JOIN
                                     REGIONS r ON m.REGION_CODE = r.CODE where p.post_type='multi-residential' and i.CODE_STATUT='EV'
