...
foreach($catch as $value)
{
   ...
   $addendaSql = $conn->query("SELECT * FROM ADDENDA WHERE NO_INSCRIPTION = '".$valueExplode[0]."' and NO_ADDENDA = '".$valueExplode[1]."' and ORDRE_AFFICHAGE = '".$valueExplode[3]."' ");

   if($addendaSql->num_rows===0){
    $insertSql = "INSERT INTO ADDENDA (NO_INSCRIPTION, NO_ADDENDA, CODE_LANGUE, ORDRE_AFFICHAGE, CHAMP_INUTILISE_1, CHAMP_INUTILISE_2, TEXTE)
    VALUES ('$valueExplode[0]', '$valueExplode[1]', '$valueExplode[2]','$valueExplode[3]','$valueExplode[4]','$valueExplode[5]','$valueExplode[6]')";
...
foreach($bureauxResult as $value)
{
    ...
    if($bureauxSql->num_rows===0){
        $insertSql = "INSERT INTO BUREAUX (CODE, FIRME_CODE, NOM_LEGAL, NO_CIVIQUE, NOM_RUE, BUREAU, MUNICIPALITE, PROVINCE, CODE_POSTAL, TELEPHONE_1, POSTE_1, TELEPHONE_2, POSTE_2, TELEPHONE_FAX, COURRIEL, SITE_WEB, DIRECTEUR_CODE, URL_LOGO_BUREAU)
        VALUES ('$valueExplode[0]', '$valueExplode[1]', '$valueExplode[2]','$valueExplode[3]','$valueExplode[4]','$valueExplode[5]','$valueExplode[6]','$valueExplode[7]','$valueExplode[8]','$valueExplode[9]','$valueExplode[10]','$valueExplode[11]','$valueExplode[12]','$valueExplode[13]','$valueExplode[14]','$valueExplode[15]','$valueExplode[16]','$valueExplode[17]')";
        $conn->query($insertSql);
    }
}
...
foreach($caracteristiquesResult as $value)
{
  ...
  $replaceValue= str_replace('"',"",str_replace('Ã©',"é",$value1));
    $valueExplode=explode(",",$replaceValue);
    $csSql = $conn->query("SELECT * FROM CARACTERISTIQUES WHERE NO_INSCRIPTION = '".$valueExplode[0]."' and TCAR_CODE = '".$valueExplode[1]."' and SCARAC_CODE = '".$valueExplode[2]."'");
...
foreach($depensesResult as $value)
{
    ...
    $csSql = $conn->query("SELECT * FROM DEPENSES WHERE NO_INSCRIPTION = '".$valueExplode[0]."' and TDEP_CODE = '".$valueExplode[2]."' and PART_DEPENSE = '".$valueExplode[7]."'");

    if($csSql->num_rows===0){
        $insertSql = "INSERT INTO DEPENSES
        VALUES ('$valueExplode[0]', '$valueExplode[1]', '$valueExplode[2]','$valueExplode[3]','$valueExplode[4]','$valueExplode[5]','$valueExplode[6]','$valueExplode[7]','$valueExplode[8]')";
        $conn->query($insertSql);
...
foreach($inscriptionsResult as $value)
{
    ...
    if($csSql->num_rows===0){
        ...
        VALUES ('$valueExplode[0]', '$valueExplode[1]', '$valueExplode[2]', '$valueExplode[3]', '$valueExplode[4]', '$valueExplode[5]', '$valueExplode[6]', '$valueExplode[7]', '$valueExplode[8]', '$valueExplode[9]', '$valueExplode[10]', '$valueExplode[11]', '$valueExplode[12]', '$valueExplode[13]', '$valueExplode[14]', '$valueExplode[15]', '$valueExplode[16]', '$valueExplode[17]', '$valueExplode[18]', '$valueExplode[19]', '$valueExplode[20]', '$valueExplode[21]', '$valueExplode[22]', '$valueExplode[23]', '$valueExplode[24]', '$valueExplode[25]', '$valueExplode[26]', '".str_replace('~',", ",$valueExplode[27])."', '$valueExplode[28]', '$valueExplode[29]', '$valueExplode[30]', '$valueExplode[31]', '$valueExplode[32]', '$valueExplode[33]', '$valueExplode[34]', '$valueExplode[35]', '$valueExplode[36]', '$valueExplode[37]', '$valueExplode[38]', '$valueExplode[39]', '$valueExplode[40]', '$valueExplode[41]', '$valueExplode[42]', '$valueExplode[43]', '$valueExplode[44]', '$valueExplode[45]', '$valueExplode[46]', '$valueExplode[47]', '$valueExplode[48]', '$valueExplode[49]', '$valueExplode[50]', '$valueExplode[51]', '$valueExplode[52]', '$valueExplode[53]', '$valueExplode[54]', '$valueExplode[55]', '$valueExplode[56]', '$valueExplode[57]', '$valueExplode[58]', '$valueExplode[59]', '$valueExplode[60]', '$valueExplode[61]', '$valueExplode[62]', '$valueExplode[63]', '$valueExplode[64]', '$valueExplode[65]', '$valueExplode[66]', '$valueExplode[67]', '$valueExplode[68]', '$valueExplode[69]', '$valueExplode[70]', '$valueExplode[71]', '$valueExplode[72]', '$valueExplode[73]', '$valueExplode[74]', '$valueExplode[75]', '$valueExplode[76]', '$valueExplode[77]', '$valueExplode[78]', '$valueExplode[79]', '$valueExplode[80]', '$valueExplode[81]', '$valueExplode[82]', '$valueExplode[83]', '$valueExplode[84]', '$valueExplode[85]', '$valueExplode[86]', '$valueExplode[87]', '$valueExplode[88]', '$valueExplode[89]', '$valueExplode[90]', '$valueExplode[91]', '$valueExplode[92]', '$valueExplode[93]', '$valueExplode[94]', '$valueExplode[95]', '$valueExplode[96]', '$valueExplode[97]', '$valueExplode[98]', '$valueExplode[99]', '".str_replace('~',", ",$valueExplode[100])."', '".str_replace('~',", ",$valueExplode[101])."', '$valueExplode[102]', '$valueExplode[103]', '$valueExplode[104]', '$valueExplode[105]', '$valueExplode[106]', '$valueExplode[107]', '$valueExplode[108]', '$valueExplode[109]', '$valueExplode[110]', '$valueExplode[111]', '$valueExplode[112]', '$valueExplode[113]', '$valueExplode[114]', '$valueExplode[115]', '$valueExplode[116]', '$valueExplode[117]', '$valueExplode[118]', '$valueExplode[119]', '$valueExplode[120]', '$valueExplode[121]', '$valueExplode[122]', '$valueExplode[123]', '$valueExplode[124]', '$valueExplode[125]', '$valueExplode[126]', '$valueExplode[127]', '$valueExplode[128]', '$valueExplode[129]', '$valueExplode[130]', '$valueExplode[131]', '$valueExplode[132]', '$valueExplode[133]', '$valueExplode[134]', '$valueExplode[135]', '$valueExplode[136]', '$valueExplode[137]', '$valueExplode[138]', '$valueExplode[139]', '$valueExplode[140]', '$valueExplode[141]', '$valueExplode[142]', '$valueExplode[143]', '$valueExplode[144]', '$valueExplode[145]', '$valueExplode[146]', '$valueExplode[147]', '$valueExplode[148]', '$valueExplode[149]', '$valueExplode[150]', '$valueExplode[151]', '$valueExplode[152]', '$valueExplode[153]', '$valueExplode[154]', '$valueExplode[155]', '$valueExplode[156]')";
        $conn->query($insertSql);
...
foreach($liensAdditionnelsResult as $value)
{
    ...
    $csSql = $conn->query("SELECT * FROM LIENS_ADDITIONNELS WHERE NO_INSCRIPTION = '".$valueExplode[0]."' and SEQ = '".$valueExplode[1]."'  ");
...
foreach($photosResult as $value)
{
  ...
  $csSql = $conn->query("SELECT * FROM PHOTOS WHERE NO_INSCRIPTION = '".$valueExplode[0]."' and SEQ='".$valueExplode[1]."' ");
...
foreach($piecesUnitesResult as $value)
{
  ...
  $csSql = $conn->query("SELECT * FROM PIECES_UNITES WHERE NO_INSCRIPTION = '".$valueExplode[0]."' and SEQ_UNITE_DET='". $valueExplode[1]."' and SEQ='".$valueExplode[2]."' ");

  if($csSql->num_rows===0){
      $insertSql = "INSERT INTO PIECES_UNITES
      VALUES ('$valueExplode[0]','$valueExplode[1]','$valueExplode[2]','$valueExplode[3]','$valueExplode[4]','$valueExplode[5]','$valueExplode[6]','$valueExplode[7]','$valueExplode[8]','$valueExplode[9]','$valueExplode[10]','$valueExplode[11]','$valueExplode[12]','$valueExplode[13]','$valueExplode[14]','$valueExplode[15]','$valueExplode[16]')";
      $conn->query($insertSql);
...
foreach($remarquesResult as $value)
{
  ...
  $csSql = $conn->query("SELECT * FROM REMARQUES WHERE NO_INSCRIPTION = '".$valueExplode[0]."' and NO_REMARQUE='".$valueExplode[1]."' and ORDRE_AFFICHAGE='".$valueExplode[2]."' ");
...
foreach($renovationsResult as $value)
{
  ...
  $replaceValue= str_replace('"',"",str_replace('Ã©',"é",$value1));
  $valueExplode=explode(",",$replaceValue);
  $csSql = $conn->query("SELECT * FROM RENOVATIONS WHERE NO_INSCRIPTION = '".$valueExplode[0]."' and SEQ='".$valueExplode[1]."' ");

  if($csSql->num_rows===0){
      $insertSql = "INSERT INTO RENOVATIONS
      VALUES ('$valueExplode[0]','$valueExplode[1]','$valueExplode[2]','$valueExplode[3]','$valueExplode[4]','$valueExplode[5]','$valueExplode[6]','$valueExplode[7]')";
      $conn->query($insertSql);
...
foreach($unitesDResult as $value)
{
  ...
  $replaceValue= str_replace('"',"",str_replace('Ã©',"é",$value1));
  $valueExplode=explode(",",$replaceValue);
  $csSql = $conn->query("SELECT * FROM UNITES_DETAILLEES WHERE NO_INSCRIPTION = '".$valueExplode[0]."' and SEQ='".$valueExplode[1]."' and TYPE_UNITE_DET='".$valueExplode[2]."' ");
...
foreach($unitesSResult as $value)
{
  ...
  $replaceValue= str_replace('"',"",str_replace('Ã©',"é",$value1));
  $valueExplode=explode(",",$replaceValue);
  $csSql = $conn->query("SELECT * FROM UNITES_SOMMAIRES WHERE NO_INSCRIPTION = '".$valueExplode[0]."' and SEQ='".$valueExplode[1]."' ");
...
foreach($unitesSResult as $value)
{
  ...
  $csSql = $conn->query("SELECT * FROM VALEURS_FIXES WHERE DOMAINE = '".$valueExplode[0]."' and VALEUR='".$valueExplode[1]."' ");

  if($csSql->num_rows===0){
      $insertSql = "INSERT INTO VALEURS_FIXES
      VALUES ('$valueExplode[0]','$valueExplode[1]','$valueExplode[2]','$valueExplode[3]','$valueExplode[4]','$valueExplode[5]')";
      $conn->query($insertSql);
...
foreach($visitesLibresileResult as $value)
{
  ...
  $csSql = $conn->query("SELECT * FROM VISITES_LIBRES WHERE NO_INSCRIPTION = '".$valueExplode[0]."' and SEQ='".$valueExplode[1]."' ");

  if($csSql->num_rows===0){
      $insertSql = "INSERT INTO VALEURS_FIXES
      VALUES ('$valueExplode[0]','$valueExplode[1]','$valueExplode[2]','$valueExplode[3]','$valueExplode[4]','$valueExplode[5]','$valueExplode[6]','$valueExplode[7]','$valueExplode[8]','$valueExplode[9]')";
      $conn->query($insertSql);
...
$posts = $conn->query("SELECT * FROM wp_posts where post_content='".$value['NO_INSCRIPTION']."'");
if($posts->num_rows===0){
    // // Create post object
    $postType="";
    ...
    $insertSql = "INSERT INTO wp_posts (post_title,post_content,post_status,post_type,post_author,post_category)
    VALUES ('".$value['NOM_RUE_COMPLET']."','".$value['NO_INSCRIPTION']."','publish','".$postType."','1','".array(1 )."')";
    $conn->query($insertSql);
