        ...
        <div class="pxp-content pt-100">
            <div class="pxp-services-h pt-100 pb-100">
                <div class="container">
                    ...
                    <a href="<?php bloginfo('url'); ?>/sale-form" class="pxp-primary-cta text-uppercase pxp-animate"><span class="fa fa-phone"></span> <?php _e('book a consultation','theme-text-domain'); ?></a>
            ...
            <div class="pxp-services-h pt-100 pb-100">
                <div class="container">
                    <div class="pxp-services-h-container mt-4 mt-md-5">
                        <div class="pxp-services-h-fig pxp-cover pxp-animate-in rounded-lg" style="background-image: url(<?php echo $sale_info_page_section_four_image; ?>);"></div>
                        <div class="pxp-services-h-items pxp-animate-in ml-0 ml-lg-5 mt-4 mt-md-5 mt-lg-0">
